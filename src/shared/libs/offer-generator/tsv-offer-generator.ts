...
import { MockServerData, Premium, UserType } from '../../types/index.js';
...
export class TSVOfferGenerator implements OfferGenerator {
  ...
  public generate(): string {
    ...
    const premium = getRandomItem([Premium.premium, Premium.default]);
    ...
    const authorType = getRandomItem([UserType.pro, UserType.default]);
